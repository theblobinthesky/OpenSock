    ...
    <div className="max-w-3xl mx-auto px-4 py-3">
      <div className="bg-white rounded-2xl shadow-sm ring-1 ring-slate-200 p-5">
        ...
        <div className="space-y-3 text-gray-800 leading-7">
          <p>{i18n.t('privacy.p1') || 'We store only the images you submit, plus optional display name, social handle, and email. Numeric focal length may be parsed if present. No trackers or analytics are used.'}</p>
